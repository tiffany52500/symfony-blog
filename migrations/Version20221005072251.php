 ...
 */
final class Version20221005072251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD auteur_id INT DEFAULT NULL, ADD article_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP auteur_id, DROP article_id');
    }
}
